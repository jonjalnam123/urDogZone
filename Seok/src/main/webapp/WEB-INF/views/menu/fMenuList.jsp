...
<script src="${pageContext.request.contextPath}/resources/static/js/menu/fMenuList.js"></script>
...
<div class="content-wrapper">
  ...
  <div class="page-header">
    ...
    <div class="breadcrumb">
      <a href="#">관리자</a> &gt; <span>대매뉴 목록</span>
    </div>
  </div>
  
  <%-- <!-- 검색 조건 -->
  <div class="search-bar">
    <form class="search-form" action="/menu/fMenuList.do" method="get" id="seacrhForm">
